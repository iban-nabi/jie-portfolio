    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      ...
      <div className="bg-white rounded-lg shadow-lg mt-8 p-6 sm:p-10 md:p-16 max-w-screen-xl w-full text-center">
        ...
        <p className="text-gray-700 text-lg sm:text-xl md:text-2xl px-4 sm:px-10 md:px-14 mb-5 sm:mb-7 ">
          I am a hard-working and responsible individual who enjoys working with
          backend technologies and solving logic-related problems. I can work in
          both independent and group scenarios. I am dedicated to completing my
          tasks and projects and am open to learning new knowledge and skills
          that will help me grow in the tech industry.
        </p>
